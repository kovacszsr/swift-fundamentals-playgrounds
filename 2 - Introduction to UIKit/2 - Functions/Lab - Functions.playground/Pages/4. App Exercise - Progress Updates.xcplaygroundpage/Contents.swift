...
func progressUpdate(_ steps: Int, _ goal: Int) {
    ...
    let result = Int(Double(steps) / Double(goal) * 100)
...
progressUpdate(400, 10000)
progressUpdate(1500, 10000)
progressUpdate(5000, 10000)
progressUpdate(9500, 10000)
progressUpdate(11000, 10000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    let estimatedTime = totalDistance / speed
...
pacing(currentDistance: 150, totalDistance: 1000, currentTime: 10.4, goalTime: 150)
