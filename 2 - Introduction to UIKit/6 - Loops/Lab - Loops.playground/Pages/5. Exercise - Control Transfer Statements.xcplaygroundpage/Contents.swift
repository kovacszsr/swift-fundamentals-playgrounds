...
for (index, letter) in alphabet.enumerated() {
    ...
    var shouldPrint = index.isMultiple(of: 2)
...
var countys: [String: String] = ["Baranya": "Pécs", "Somogy": "Kaposvár", "Tolna": "Szekszárd"]

for (county, city) in countys {
    print("County: \(county) and city: \(city)")
