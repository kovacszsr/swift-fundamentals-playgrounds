...
var zsofi = User(name: "Zsófi", age: 25, height: 170, weight: 62, activityLevel: 8)

print("Name: \(zsofi.name), age: \(zsofi.age), height: \(zsofi.height), weight: \(zsofi.weight), activity level: \(zsofi.activityLevel)")
...
var otherDistance = Distance(feet: 5000)
print(otherDistance.meters)

//var otherDistanceInMeter = Distance(meters: 1523.9999512320016)
//print(otherDistanceInMeter.feet)
